...
## Context
Detects volume anomalies overall and per topic/destination and semantically clusters a surge, feeding crisis mode. Governing spec: [`M9`](../specs/M9-crisis-mode.md). Do not restate the spec — trace the ids.
...
- [ ] `FR-M9-01` — <testable statement from the spec>
- [ ] `FR-M9-02` — <testable statement from the spec>
